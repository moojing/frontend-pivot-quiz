    ...
    return (
      <div className="flex items-center justify-center h-full text-gray-400">
        <div className="text-center">
          <p>Run tests to validate your solution.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      {allPassed && (
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <h4 className="font-semibold text-blue-900 mb-2">Great work.</h4>
          <p className="text-sm text-blue-800">
            You have validated the core pivot-and-merge logic. Next, improve readability, edge-case handling, or performance.
          </p>
        </div>
      )}
    </div>
